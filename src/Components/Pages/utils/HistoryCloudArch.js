...
export default function HistoryCloudArch() {
    ...
    <div>
      ...
      {!isLoading && currHistoryArch && (
        <>
          <h2>
            {currHistoryArch
              ? currHistoryArch.prompt.charAt(0).toUpperCase() + currHistoryArch.prompt.slice(1) + ": " + currHistoryArch.cloudType
              : ""}
          </h2>

          <MermaidComp chart={currHistoryArch ? currHistoryArch.nativeArch : ""} desc={currHistoryArch.nativeArchDesc}/>
        </>
      )}
